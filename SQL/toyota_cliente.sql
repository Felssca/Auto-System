...
CREATE TABLE `cliente` (
  ...
  `telefone_res` varchar(15) character set latin1 default NULL,
  `telefone_cel` varchar(15) character set latin1 default NULL,
  `telefone_comercial` varchar(15) character set latin1 default NULL,
  `cpf` varchar(11) character set latin1 default NULL,
  `dt_aniversario` date default NULL,
  `rg` varchar(7) character set latin1 default NULL,
